...
<div class="row" id="customer_login">
    <div class="col-lg-6 col-md-12">
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <p class="form-row form-group">
                ...
                <button type="submit" class="woocommerce-button button woocommerce-form-login__submit btn-primary btn" name="login"
	...
	<div class="col-lg-1 d-lg-flex d-md-none col-sep justify-content-center align-items-center"><div></div>
	</div>
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register"
            ...
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-group">
                <label for="reg_password"><?php esc_html_e( 'Password', 'woocommerce' ); ?>&nbsp;<span
                        class="required">*</span></label>
                <input type="password" class="woocommerce-Input woocommerce-Input--text input-text form-control" name="password"
            ...
            <p class="woocommerce-form-row form-row">
                ...
                <button type="submit"
                    class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit btn-primary btn"
                    name="register"
